...
// device_shadow keeps its NVS schema version under a u8 "ver" key — the
// zap_store harness never used u8, so these are added here (defined in
// stubs/nvs_u8_stub.cpp) to keep nvs_stub.cpp a verbatim copy.
